                            ...
                            <tbody>
                                ...
                                ?>
                                        ...
                                        <tr>
                                            ...
                                            <td><?= $provedor['tipo_provedor'] ?></td>
                                            <td><?= $provedor['direccion'] ?></td>
                                            <td><?= $provedor['telefono'] ?></td>
                                            <td><?= $provedor['correo'] ?></td>
                                            <td><?= $provedor['fi_ingreso'] ?></td>
                                            <td>

                                                <a class="btn" type="button"
                                                    style="border-bottom: 1px solid #5f5d5d; background: #147447; color: white;" href="/Banco-de-sangre/Provedores/editar/?id=<?php echo $provedor['id_provedor']; ?>">Editar</a>

                                                <?php if ($provedor['estado'] == 1) { ?>

                                                    <a class="btn"
                                                        style="background: #f51400e7; color: #fff; border: rgba(49, 45, 45, 0.9) 1px solid;" href="/Banco-de-sangre/Provedores/Eliminar/?id=<?php echo $provedor['id_provedor']; ?>">Desactivar</a>

                                                <?php } else { ?>

                                                    <a class="btn"
                                                        style="background: #f51400e7; color: #fff; border: rgba(49, 45, 45, 0.9) 1px solid;" href="/Banco-de-sangre/Provedores/Activar/?id=<?php echo $provedor['id_provedor']; ?>">Activar</a>
