            ...
            <main class="container px-0 mt-4 pb-3">
                ...
                <div class="row mt-3">
                    <div class="d-flex gap-3 justify-content-between">
                        ...
                        <form class="d-flex align-items-center" method="post" action="/Banco-de-sangre/TipoExamen/Mostrar/">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="container my-3 ">
                                            ...
                                            <div class="row col-md-8 offset-md-2">
                                                ...
                                                <form action="/Banco-de-sangre/TipoExamen/Crear/" method="POST" class="row g-3 border-black mt-3 pt-5 py-4 rounded d-flex align-items-center flex-column w-100" style="background: #ececec;">
                                                    ...
                                                    <div class="row d-flex justify-content-center align-items-center">
                                                        ...
                                                        <div class="col-10">
                                                            ...
                                                            <input class="form-control border-secondary" type="text" name="Nombre" required minlength="3" maxlength="10" id="">
                                                    ...
                                                    <div class="row mt-3 d-flex justify-content-center align-items-center">
                                                        ...
                                                        <div class="col-10">
                                                            ...
                                                            <input class="form-control border-secondary" type="text" name="Categoria" required minlength="3" maxlength="10" id="">
                    ...
                    <div class="table-responsive card-body">
                        ...
                        <table class="table table-striped text-center">
                            ...
                            <tbody>
                                ...
                                <?php if (!empty($tipoexamen)) {
                                    $iterador = 0;
                                    foreach ($tipoexamen as $tiposexamen):
                                ?>
                                        ...
                                        <tr>
                                            <th><?= $iterador; ?></th>
                                            <td><?= $tiposexamen['Nombre_Examen'] ?></td>
                                            <td><?= $tiposexamen['Descripcion'] ?></td>
                                            <td><?= $tiposexamen['Categoria'] ?></td>

                                            <td class="d-flex flex-column">

                                                <div class="d-flex flex-column align-items-center">
                                                    <a class="btn" type="button"
                                                        style="border-bottom: 1px solid #5f5d5d; background: #147447; color: white;" href="/Banco-de-sangre/TipoExamen/Editar/?id=<?php echo $tiposexamen['ID_Tipo_Examen']; ?>">Editar</a>

                                                    <?php if ($tiposexamen['Estado'] == 1) { ?>

                                                        <a class="btn"
                                                            style="background: #f51400e7; color: #fff; border: rgba(49, 45, 45, 0.9) 1px solid;" href="/Banco-de-sangre/TipoExamen/CambiarEstado/?id=<?php echo $tiposexamen['ID_Tipo_Examen']; ?>&cambio=2" onclick="Esta Seguro de Desactivar al donante">Desactivar</a>

                                                    <?php } elseif ($tiposexamen['Estado'] == 2) { ?>

                                                        <a class="btn"
                                                            style="background: #f51400e7; color: #fff; border: rgba(49, 45, 45, 0.9) 1px solid;" href="/Banco-de-sangre/TipoExamen/CambiarEstado/?id=<?php echo $tiposexamen['ID_Tipo_Examen']; ?>&cambio=1">Activar</a>
