        ...
        <div class="row col-md-8 offset-md-2">
            ...
            <form action="/Banco-de-sangre/Provedores/EditarProvedor/" method="POST" class="row g-3 border-black mt-3 pt-5 py-4 rounded d-flex align-items-center flex-column w-100" style="background: #ececec;">
                ...
                <?php foreach ($provedores as $provedor): ?>
                    ...
                    <input type="hidden" name="id" value="<?= $provedor['ID_proveedor'] ?>">
                    ...
                    <div class="row mt-3">
                        ...
                        <div class="col-12">
                            ...
                            <input class="form-control border-secondary" type="text" name="tipo" value="<?= $provedor['Tipo_proveedor'] ?>" required minlength="3" maxlength="15" id="">
                    ...
                    <div class="row mt-3">
                        ...
                        <div class="col-12">
                            ...
                            <input class="form-control border-secondary" type="date" name="fecha" value="<?= $provedor['FI_po'] ?>" required id="">
