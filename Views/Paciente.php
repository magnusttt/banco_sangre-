            ...
            <main class="container px-0 mt-4 pb-3">
                ...
                <div class="row mt-3">
                    <div class="d-flex gap-3 justify-content-between">
                        ...
                        <form class="d-flex align-items-center" method="post" action="/Banco-de-sangre/Paciente/Mostrar/">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="container my-3 ">
                                            ...
                                            <div class="d-flex justify-content-center">
                                                ...
                                                <h2 class="text-center mb-2 text-white pb-3 w-50 border-bottom border-white">Agregar Paciente</h2>

                                            </div>

                                            <div class="row col-md-8 offset-md-2">

                                                <form action="/Banco-de-sangre/Paciente/Crear/" method="POST" class="row g-3 border-black mt-3 pt-5 py-4 rounded d-flex align-items-center flex-column w-100" style="background: #ececec;">
                                                    ...
                                                    <div class="row d-flex">
                                                        ...
                                                        <div class="col-6">
                                                            ...
                                                            <input class="form-control border-secondary" type="text" name="p_nombre" required minlength="3" maxlength="10" id="">
                                                        ...
                                                        <div class="col-6">
                                                            ...
                                                            <input class="form-control border-secondary" type="text" name="s_nombre" minlength="3" maxlength="10" id="">
                                                    ...
                                                    <div class="row d-flex mt-3">
                                                        ...
                                                        <div class="col-6">
                                                            ...
                                                            <input class="form-control border-secondary" type="text" name="p_apellido" required minlength="3" maxlength="15" id="">
                                                        ...
                                                        <div class="col-6">
                                                            ...
                                                            <input class="form-control border-secondary" type="text" name="s_apellido" minlength="3" maxlength="15" id="">
                                                    ...
                                                    <div class="row mt-3">
                                                        ...
                                                        <div class="col-8">
                                                            ...
                                                            <input class="form-control border-secondary" inputmode="numeric" pattern="{11}[0,11]" title="Ingrese un numero valido" name="telefono" required id="">
                                                    ...
                                                    <div class="row mt-3">
                                                        ...
                                                        <div class="col-8">
                                                            ...
                                                            <input class="form-control border-secondary" type="number" name="cedula" required min="0" max="99999999" id="">
                                                    ...
                                                    <div class="row mt-3">
                                                        ...
                                                        <div class="col-8">
                                                            ...
                                                            <input class="form-control border-secondary" type="text" name="Descripcion" required minlength="4" maxlength="100" id="">
                                                    ...
                                                    <div class="row mt-3 d-flex justify-content-center align-items-center">
                                                        ...
                                                        <div class="col-6 text-center">
                                                            ...
                                                            <input class="form-control border-secondary" type="date" name="fecha_n" required id="">
                                                        ...
                                                        <div class="col-6 text-center">
                                                            ...
                                                            <input class="form-control border-secondary" type="date" name="fecha_i" required id="">
                ...
                <div class="card content-dont mt-5">
                    <div class="card-header">
                        ...
                        <?php if ($estado == 2) { ?>
                            ...
                            <h6 class="text-center">Inactivos</h6>

                        <?php } else { ?>

                            <h6 class="text-center">Activos</h6>
                        ...
                        <table class="table table-striped text-center">
                            ...
                            <tbody>
                                ...
                                ?>
                                        ...
                                        <tr>
                                            <th><?= $iterador; ?></th>
                                            <th><?= $pacientes['Nacionalidad']; ?></th>
                                            <th scope="row"><?= $pacientes['CI'] ?></th>
                                            <td><?= $pacientes['Primer_nombre'] ?> <?= $pacientes['Segundo_nombre'] ?></td>
                                            <td><?= $pacientes['Primer_apellido'] ?> <?= $pacientes['Segundo_apellido'] ?></td>
                                            <td><?= $pacientes['Tipo_sangre'] ?></td>
                                            <td><?= $pacientes['Telefono'] ?></td>
                                            <td><?= $pacientes['Direccion'] ?></td>
											<td><?= $pacientes['Descripcion'] ?></td>
                                            <td><?= $pacientes['Fecha_Nacimiento'] ?></td>
                                            <td><?= $pacientes['Fecha_Ingreso_info_Paciente'] ?></td>

                                            <td class="d-flex flex-column">

                                                <div class="d-flex flex-column align-items-center">
                                                    <a class="btn" type="button"
                                                        style="border-bottom: 1px solid #5f5d5d; background: #147447; color: white;" href="/Banco-de-sangre/Paciente/Editar/?id=<?php echo $pacientes['ID_paciente']; ?>">Editar</a>
                                                    <a href="/Banco-de-sangre/Inventario/registrarTransfusionVista/?id=<?php echo $pacientes['ID_paciente']; ?>&Tipo_sangre=<?php echo $pacientes['Tipo_sangre']; ?>" class="btn btn-danger">Transfusión</a>
                                                    <?php if ($pacientes['Estado'] == 1) { ?>

                                                        <a class="btn"
                                                            style="background: #f51400e7; color: #fff; border: rgba(49, 45, 45, 0.9) 1px solid;" href="/Banco-de-sangre/Paciente/CambiarEstado/?id=<?php echo $pacientes['ID_paciente']; ?>&cambio=2" onclick="Esta Seguro de Desactivar al donante">Desactivar</a>

                                                    <?php } elseif ($pacientes['Estado'] == 2) { ?>

                                                        <a class="btn"
                                                            style="background: #f51400e7; color: #fff; border: rgba(49, 45, 45, 0.9) 1px solid;" href="/Banco-de-sangre/Paciente/CambiarEstado/?id=<?php echo $pacientes['ID_paciente']; ?>&cambio=1">Activar</a>
