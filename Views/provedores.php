            ...
            <main class="container px-0 mt-4 pb-3">
                ...
                <div class="row mt-3">
                    <div class="d-flex gap-3 justify-content-between">
                        ...
                        <form class="d-flex align-items-center" method="post" action="/Banco-de-sangre/Provedores/Mostrar/">
                        ...
                        <!-- Modal de agregar -->
                        <div class="modal fade" id="modalagregar2" tabindex="-1" aria-labelledby="exampleModalLabel"
                            aria-hidden="true">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="container my-3 ">
                                            ...
                                            <div class="d-flex justify-content-center">
                                                ...
                                                <h2 class="text-center mb-2 text-white pb-3 w-50 border-bottom border-white">Agregar Proveedor</h2>

                                            </div>

                                            <div class="row col-md-8 offset-md-2">

                                                <form action="/Banco-de-sangre/Provedores/Crear/" method="POST" class="row g-3 border-black mt-3 pt-5 py-4 rounded d-flex align-items-center flex-column w-100" style="background: #ececec;">
                                                    ...
                                                    <div class="row d-flex">
                                                        ...
                                                        <div class="col-12">
                                                            ...
                                                            <input class="form-control border-secondary" type="text" name="rif" required minlength="3" maxlength="25" id="">
                                                    ...
                                                    <div class="row d-flex mt-3">
                                                        ...
                                                        <div class="col-12">
                                                            ...
                                                            <input class="form-control border-secondary" type="text" name="nombre" required minlength="3" maxlength="15" id="">
                                                    ...
                                                    <div class="row mt-3">
                                                        ...
                                                        <div class="col-12">
                                                            ...
                                                            <input class="form-control border-secondary" type="text" name="tipo" required minlength="3" maxlength="15" id="">
                                                    ...
                                                    <div class="row mt-3">
                                                        ...
                                                        <div class="col-12">
                                                            ...
                                                            <input class="form-control border-secondary" type="text" name="direccion" required minlength="3" maxlength="50" id="">
                                                    ...
                                                    <div class="row mt-3">
                                                        ...
                                                        <div class="col-12">
                                                            ...
                                                            <label for="" class="form-label">Telefono Publico</label>
                                                            <input class="form-control border-secondary" type="number" name="telefono" min="0" id="">
                                                    ...
                                                    <div class="row mt-3">
                                                        ...
                                                        <div class="col-12">
                                                            ...
                                                            <input class="form-control border-secondary" type="email" name="correo" required minlength="3" maxlength="20" id="">
                                                    ...
                                                    <div class="row mt-3">
                                                        ...
                                                        <div class="col-12">
                                                            ...
                                                            <input class="form-control border-secondary" type="number" name="contacto" required min="0" id="">
                                                    ...
                                                    <div class="row mt-3">
                                                        ...
                                                        <div class="col-12">
                                                            ...
                                                            <input class="form-control border-secondary" type="date" name="fecha" required id="">
                ...
                <div class="card content-dont mt-5">
                    <div class="card-header">
                        ...
                        <?php if ($estado == 2) { ?>
                            ...
                            <h6 class="text-center">Inactivas</h6>

                        <?php } else { ?>

                            <h6 class="text-center">Activas</h6>
                        ...
                        <table class="table table-striped text-center">
                            <thead class="">
                                <tr>
                                    ...
                                    <th scape="col">Tipo de proveedor</th>
                                    <th scope="col">Direccion</th>
                                    <th scope="col">Telefono Publico</th>
                            ...
                            <tbody>
                                ...
                                ?>
                                        ...
                                        <tr>
                                            ...
                                            <td><?= $provedor['Tipo_proveedor'] ?></td>
                                            <td><?= $provedor['Direccion'] ?></td>
                                            <td><?= $provedor['Telefono'] ?></td>
                                            <td><?= $provedor['FI_po'] ?></td>
                                            <td>

                                                <a class="btn" type="button"
                                                    style="border-bottom: 1px solid #5f5d5d; background: #147447; color: white;" href="/Banco-de-sangre/Provedores/editar/?id=<?php echo $provedor['ID_proveedor']; ?>">Editar</a>

                                                <?php if ($provedor['Estado'] == 1) { ?>

                                                    <a class="btn"
                                                        style="background: #f51400e7; color: #fff; border: rgba(49, 45, 45, 0.9) 1px solid;" href="/Banco-de-sangre/Provedores/Eliminar/?id=<?php echo $provedor['ID_proveedor']; ?>">Desactivar</a>

                                                <?php } else { ?>

                                                    <a class="btn"
                                                        style="background: #f51400e7; color: #fff; border: rgba(49, 45, 45, 0.9) 1px solid;" href="/Banco-de-sangre/Provedores/Activar/?id=<?php echo $provedor['ID_proveedor']; ?>">Activar</a>
                                    ...
                                    <tr>
                                        <td colspan='12'>No se encontro Ningun Registro</td>
                                    </tr>
