                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="container my-3 ">
                                            ...
                                            <div class="d-flex justify-content-center">
                                                ...
                                                <h2 class="text-center mb-2 text-white pb-3 w-50 border-bottom border-white">Agregar Donante</h2>

                                            </div>

                                            <div class="row col-md-8 offset-md-2">

                                                <form action="/Banco-de-sangre/Donante/Crear/" method="POST" class="row g-3 border-black mt-3 pt-5 py-4 rounded d-flex align-items-center flex-column w-100" style="background: #ececec;">
                        ...
                        <table class="table table-striped text-center">
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th scape="col">Tipo de sangre</th>
                                    <th scape="col">Telefono</th>
                                    <th scape="col">Dirección</th>
                                    <th scope="col">Fecha nacimiento</th>
                                    <th scape="col">Fecha de Ingreso</th>
                                    <th scope="col">Acciones</th>
                                </tr>
                            </thead>
                            <tbody>

                                <?php if (!empty($donante)) {
                                    $iterador = 0;
                                    foreach ($donante as $donantes):
                                ?>
                                        ...
                                        <tr>
                                            <th><?= $iterador; ?></th>
                                            <th><?= $donantes['Nacionalidad']; ?></th>
                                            <th scope="row"><?= $donantes['CI'] ?></th>
                                            <td><?= $donantes['primer_nombre'] ?> <?= $donantes['segundo_nombre'] ?></td>
                                            <td><?= $donantes['primer_apellido'] ?> <?= $donantes['segundo_apellido'] ?></td>
                                            <td><?= $donantes['Tipo_sangre'] ?></td>
                                            <td><?= $donantes['Telefono'] ?></td>
                                            <td><?= $donantes['Direccion'] ?></td>
                                            <td><?= $donantes['Fecha_Nacimiento'] ?></td>
                                            <td><?= $donantes['Fecha_Ingreso_info_Donante'] ?></td>
                                            ...
                                            <td class="d-flex flex-column">
                                                ...
                                                <div class="d-flex flex-column align-items-center">
                                                    ...
                                                    <a class="btn" type="button"
                                                        style="border-bottom: 1px solid #5f5d5d; background: #147447; color: white;" href="/Banco-de-sangre/Donante/Editar/?id=<?php echo $donantes['ID_Donante']; ?>">Editar</a>

                                                    <a class="btn" type="button"
                                                        style="border-bottom: 1px solid #5f5d5d; background:rgb(122, 17, 43); color: white;" href="/Banco-de-sangre/Inventario/registrarDonacionVista/?id=<?php echo $donantes['ID_Donante']; ?>">Donacion</a>

                                                    <?php if ($donantes['Estado'] == 1) { ?>

                                                        <a class="btn"
                                                            style="background: #f51400e7; color: #fff; border: rgba(49, 45, 45, 0.9) 1px solid;" href="/Banco-de-sangre/Donante/eliminar/?id=<?php echo $donantes['ID_Donante']; ?>" onclick="Esta Seguro de Desactivar al donante">Desactivar</a>

                                                    <?php } else { ?>

                                                        <a class="btn"
                                                            style="background: #f51400e7; color: #fff; border: rgba(49, 45, 45, 0.9) 1px solid;" href="/Banco-de-sangre/Donante/Activar/?id=<?php echo $donantes['ID_Donante']; ?>">Activar</a>
