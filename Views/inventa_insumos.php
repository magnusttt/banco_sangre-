            ...
            <main class="container px-0 mt-4 pb-3">
                ...
                <div class="row mt-3">
                    <div class="d-flex gap-3 justify-content-start">
                        <a href="/Banco-de-sangre/Insumos/registrarInsumoVista/" class="btn btn-danger">Registrar Insumo</a>
                    </div>
                </div>
                        ...
                        <table class="table text-center">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-info" scope="col">Disponibles</th>
                                    <th class="text-info" scope="col">Usadas</th>
                                    <th class="text-info" scope="col">Vencidas</th>
                            ...
                            <tbody>
                                ...
                                if (!empty($resumen)) {
                                    foreach ($resumen as $fila) {
                                        ...
                                        echo "<td>{$fila['Usadas']}</td>";
                                        echo "<td>{$fila['Vencidas']}</td>";
                                        echo "<td>{$fila['Total']}</td>";
                                        echo "</tr>";
                                    }
                                } else {
                                    echo "<tr><td colspan='5'>No hay datos de insumos</td></tr>";
                                }
                                ?>
                            </tbody>
                        </table>
                ...
                <div class="row mt-3">
                    <div class="d-flex gap-3 justify-content-start">
                        <form class="d-flex" role="search" method="post" action="">
                            ...
                            <div class="col-4 pe-0">
                                    <select name="filtro" class="form-select border-dark">
                                        <option value="">Seleccione Categoria</option>
                                        <?php
                                        if (!empty($resumen)) {
                                            foreach ($resumen as $fila) :?>
                                            <option value="<?= $fila['ID_categoria_insumo']?>"><?= $fila['Nombre']?></option>";
                                        <?php endforeach; }?>
                                    </select>
                            </div>
                ...
                <div class="card content-dont mt-5">
                    <div class="card-header">
                        ...
                        <?php } elseif ($estado == 'Usado') { ?>
                            ...
                            <h6 class="text-center">Usados</h6>

                        <?php } elseif ($estado == 'Vencido') { ?>
                            <h6 class="text-center">Vencidos</h6>
                        <?php }?>
                    </div>
                    ...
                    <div class="card-body">
                        ...
                        <table class="table text-center">
                            <thead>
                                <tr>
                                    <th scope="col">#</th>
                                    <th class="text-info" scope="col">Codigo Fabricante</th>
                                    <th class="text-info" scope="col">Nombre</th>
                                    <th class="text-info" scope="col">Fecha Fabr</th>
                                    <th class="text-info" scope="col">Fecha Venc</th>
                                    <th class="text-info" scope="col">Estado</th>
                                    <th class="text-info" scope="col">CI o RIF del Proveedor</th>
                                    <th class="text-info" scope="col">Nombre del proveedor</th>
                                </tr>
                            </thead>
                            <tbody>
                                <?php if (!empty($insumos)) {
                                    ...
                                    foreach ($insumos as $insumo) : ?>
                                        ...
                                        <tr>
                                            <th><?= $iterador; ?></th>
                                            <th><?= $insumo['Codigo_fabricante'] ?></th>
                                            <th><?= $insumo['Nombre_insumo'] ?></th>
                                            <th><?= $insumo['Fecha_Fabricacion'] ?></th>
                                            <th><?= $insumo['Fecha_Vencimiento'] ?></th>
                                            <th><?= $insumo['Estado'] ?></th>
                                            <th><?= $insumo['Doc'] ?></th>
                                            <th><?= $insumo['Nombre_Proveedor'] ?></th>
                                        </tr>
